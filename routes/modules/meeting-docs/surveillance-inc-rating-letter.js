...
async function surveillance_inc_rating_letter_docs_routes(fastify) {
  fastify.post('/surveillance_inc_rating_letter/generate/docx', async (request, reply) => {
    try {
      ...
      const path = `generated/surveillance_inc_rating_letter_doc_${GENERATE_UUID}.docx`
  ...
  fastify.post('/surveillance_inc_rating_letter/generate/pdf', async (request, reply) => {
    try {
      ...
      const path = `generated/surveillance_inc_rating_letter_pdf_${GENERATE_UUID}.pdf`
